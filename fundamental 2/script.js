...
const jonas = {
    ...
    // calcAge: function(){
    // //  console.log(this) ; // It will return complete jonas object ..
    ...
    //    }
      ...
      getSummary: function(){
          return `${this.firstName} is a ${this.calcAge()}-years old ${jonas.job} and he has ${this.hasDriversLicense ? 'a' : 'no'} drivers's licence.` 
      }
  };
  ...
  //challenge
  // "jonas is a 46- years old teacher, and he has a drives's lecence"
...
for(let i = 0; i < jonasArray.length; i++){
  ...
  console.log(jonas[i], type jonasArray[i]) ;
}
*/
